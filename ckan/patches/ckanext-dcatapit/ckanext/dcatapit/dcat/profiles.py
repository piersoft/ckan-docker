...
class ItalianDCATAPProfile(RDFProfile):
    ...
    def _set_temporal_coverage(self, graph, dataset_dict, dataset_ref):
        ...
        if d.get('holder_identifier'):
         if "m_inf" not in (d.get("holder_identifier") or ""):
        ...
        if d.get('temporal_start'):
         ...
         if "m_inf" not in (d.get("holder_identifier") or ""): # non essendoci, setto dct:temporal con startDate il campo modified
          if startemp == False:
           if d.get('modified'):
        ...
        if value:
            ...
            if holder_id:
              ...
              if "p_TN" in holder_id:
               value='https://www.geonames.org/3165244'
